...
public abstract class BankAccount {
	/*
	 * Write a class, BankAccount, containing: instance variables: name (String),
	 * balance (double). a constructor accepting a String corresponding to the name
	 * of the account holder. a method, getBalance, that returns a double
	 * corresponding to the account balance. a method withdraw that accepts a
	 * double, and deducts the amount from the account balance.
	 * 
