...
public class TeslaDealer {
	...
	public static void main(String[] args) {
	...
	}// this closses main method
		// methods that return or accept custom class type
		public static void buy(Tesla car) { // when i put static I can directly call it in same class
		...
		public static Tesla testDrive(String model) {
			...
			Tesla car = new Tesla();// create a Tesla object
